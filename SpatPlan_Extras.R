#### Extras written by Jason D. Everett (UQ/CSIRO/UNSW). Contact J. D. Everett or Kristine C. V. Buenafe at MME, UQ.

install.packages("pacman")

pacman::p_load(sf, terra, tidyverse, rnaturalearth, prioritizr, stars, patchwork, proj4)
